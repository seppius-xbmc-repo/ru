...
class Filters(xbmcgui.Window):
    ...
    def __init__(self, *kargs):
        self.addControl(xbmcgui.ControlRadioButton(100, 250, 200, 50, 'Status', font='font14'))
        self.addControl(xbmcgui.ControlGroup(200, 250, 125, 75))
        self.addControl(xbmcgui.ControlTextBox(300, 250, 300, 300, textColor='0xFFFFFFFF'))
