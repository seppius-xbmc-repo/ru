...
class Net:
    ...
    def _update_opener(self):
        ...
        if self._proxy:
            opener = urllib2.build_opener(urllib2.HTTPCookieProcessor(self._cj), urllib2.ProxyHandler({'http': self._proxy}), urllib2.HTTPBasicAuthHandler(), http)
        else:
            opener = urllib2.build_opener(urllib2.HTTPCookieProcessor(self._cj), urllib2.HTTPBasicAuthHandler(), http)
        urllib2.install_opener(opener)



    def http_GET(self, url, headers = {}, compression = False):
        """
    ...
    def http_POST(self, url, form_data, headers = {}, compression = False):
        """
    ...
    def _fetch(self, url, form_data = {}, headers = {}, compression = False):
        """
